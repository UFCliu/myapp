...
// 字符串是否包括中文验证
$.validator.addMethod("stringChinese", function(value, element, params) {
	/*修复字符串是空也被验证为false的bug 开始 fixed by ldk*/
	if(this.optional(element) || !(/[\u4E00-\u9FA5\uF900-\uFA2D]/).test(value)){
		return true;
	}else{
		return false;
	}
	/*修复字符串是空也被验证为false的bug 结束 fixed by ldk*/
}, "不能包括中文");
// 电话号码验证
$.validator.addMethod("phone", function(value, element, params) {
	return this.optional(element) || ( /^(?:(?:0\d{2,3})-)?(?:[2-9][0-9]{6,7})(-(?:\d{3,}))?$/).test(value);
...
$.validator.addMethod("telno", function(value, element) {
	var cellphone = /^((0?1[34578]\d{9})|((0(10|2[0-9]|[3-9]\d{2}))-?[1-9]\d{6,7})(-?\d{0,5})?)$/; 
...
$.validator.addMethod("phone", function(value, element) {
	var cellphone = /^(((0(10|2[0-9]|[3-9]\d{2}))-?[1-9]\d{6,7})(-?\d{4})?)$/; 
	  return this.optional(element) || cellphone.test(value);
}, "请正确填写您的联系方式");
//手机号码
$.validator.addMethod("telphone", function(value, element) {
	var cellphone = /^((0?1[34578]\d{9})?)$/; 
	  return this.optional(element) || cellphone.test(value);
}, "请正确填写您的联系方式");
//只有数字和字母
$.validator.addMethod("checkNumberOrChar",function(value,element,params){
...
$.validator.addMethod("isDate", function(value, element,params) {   
    var tel = /^[0-9]{4}-[0-1]?[0-9]{1}-[0-3]?[0-9]{1}$/;
    return this.optional(element) || (tel.test(value));
}, "请正确输入日期格式'xxxx-xx-xx'");
