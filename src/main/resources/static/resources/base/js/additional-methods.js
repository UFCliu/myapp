...
jQuery.validator.addMethod("telno", function(value, element) {
	  ...
	  var mobile = /^((0?1[34578]\d{9})|((0(10|2[0-9]|[3-9]\d{2}))-?[1-9]\d{6,7})(-?\d{4})?)$/;
...
jQuery.validator.addMethod("chnaddress", function(value, element) {
	return this.optional(element) || /^[#\u4e00-\u9fa5_0-9a-zA-Z_\[\-\]\*\(\)（）]{0,120}$/.test(value);
	//return this.optional(element) || /^[\u4e00-\u9fa5]{3}[\u4e00-\u9fa5_0-9a-zA-Z_[-]*]{0,22}$/.test(value);
}, "请输入正确格式的地址");
...
//手机或邮箱
jQuery.validator.addMethod("teloremail", function(value, element, param) {
	...
	var mobile = /^(0?1[358]\d{9})$/;//|((0(10|2[1-3]|[3-9]\d{2}))?[1-9]\d{6,7})
