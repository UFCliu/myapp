...
//supply check
function memberSupplyInfoCheck(width){	
	if (!checkTrSelected()){
		openPopup('view',width);
		return false;
	}else{
...
//supply check
function supplySuperviseCheck(width){	
	if (!checkTrSelected()){
		openPopup('view',width);
		return false;
	}else{
		$('#member_supply_supervise_check_btn').prop("href", "contact/customer_check_info.html");
	}
}
//supply check
function supplySuperviseEditor(width){	
	if (!checkTrSelected()){
		openPopup('view',width);
		return false;
	}else{
		openPopup('edit',width);
	}
}
var openPopup = function(flag,width)
{
