		...
		<div class="box_top">
			<div class="subpage_box" style="width:800px;">
				<h1 class="subpage_title"><span>&nbsp;</span>加油记录清单
					...
					<#else>
						<input type="button" style="width:100px;" name="Submit" value="维护加油记录" id="manager">
					</#if>
				</h1>
			</div>
		</div>
					...
					<tr>
						...
						<#if manager ??>
							<td height="20" width="150">
								...
								-->
								<img src="../images/shebao/modify.png" width="25.6" onclick="updateOil(${oil.id})">
								<img src="../images/shebao/delete.png" width="25.6" onclick="deleteOil(${oil.id})">
							</td>
						</#if>
